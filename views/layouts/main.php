...
<header id="header">
    <?php
    NavBar::begin([
        'brandLabel' => Html::img('@web/img/logo.jpg'),
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; Music House <?= date('Y') ?></div>
